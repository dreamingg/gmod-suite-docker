...
RUN apt-get -y --no-install-recommends --no-install-suggests install \
    locales libgcc1 lib32stdc++6 lib32gcc1 libc6 libncurses5 libtinfo5 \
    ca-certificates unionfs-fuse curl tmux
...
ADD steamscript/update-i384.script /home/gsrv/scripts/update.script
ADD cfg/mount.cfg /home/gsrv/gmod-base/garrysmod/cfg/

RUN mkdir -p /home/gsrv/gmod-base/

# - Install
RUN ./steamcmd.sh +force_install_dir /home/gsrv/gmod-base +login anonymous +app_update 4020 validate +quit
...
RUN mkdir -p /home/gsrv/.steam/sdk32
RUN cp linux32/steamclient.so /home/gsrv/.steam/sdk32
